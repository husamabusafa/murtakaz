    ...
    <div className="space-y-8">
      <PageHeader
        ...
        subtitle={tr(
          ...
          "إعدادات الجهة والأدوار وتهيئة SSO ومسار التدقيق (نموذج أولي).",
        )}
      />
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="border-white/10 bg-white/5 text-white shadow-lg shadow-black/20 lg:col-span-2">
          ...
          <CardContent className="space-y-4 text-sm text-slate-100">
            <div className="rounded-xl border border-white/10 bg-slate-950/40 px-4 py-3">
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-200">{tr("Org name", "اسم الجهة")}</p>
              <p className="mt-1 text-white">{tr("Demo Organization", "جهة تجريبية")}</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-slate-950/40 px-4 py-3">
            ...
            <div className="rounded-xl border border-white/10 bg-slate-950/40 px-4 py-3">
              ...
              <p className="mt-1 text-slate-100">{tr("Manage users within your organization.", "إدارة المستخدمين ضمن الجهة.")}</p>
        ...
        <Card className="border-white/10 bg-white/5 text-white shadow-lg shadow-black/20">
          ...
          <CardContent className="space-y-3 text-sm text-slate-100">
            <div className="rounded-xl border border-white/10 bg-slate-950/40 px-4 py-3">
              <p className="font-semibold text-white">{tr("KPI target updated", "تحديث مستهدف مؤشر أداء رئيسي")}</p>
              <p className="mt-1 text-xs text-slate-200">{tr("Finance Ops • 3 days ago", "المالية • قبل 3 أيام")}</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-slate-950/40 px-4 py-3">
              <p className="font-semibold text-white">{tr("Initiative owner reassigned", "إعادة تعيين مسؤول مبادرة")}</p>
              <p className="mt-1 text-xs text-slate-200">{tr("PMO • 5 days ago", "مكتب إدارة المشاريع • قبل 5 أيام")}</p>
            </div>
            <div className="rounded-xl border border-white/10 bg-slate-950/40 px-4 py-3">
