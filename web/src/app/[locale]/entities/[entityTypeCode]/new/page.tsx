...
import { createOrgEntity, getOrgEntitiesByTypeCode, getOrgOwnerOptions, getOrgFormulaReferenceOptions } from "@/actions/entities";
...
export default function NewEntityPage() {
  ...
  async function handleTestFormula() {
    ...
    try {
      ...
      const value = Function("vars", "get", `"use strict";\n${body}`)(vars, get);
